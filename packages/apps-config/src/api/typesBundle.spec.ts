...
describe('typesBundle', (): void => {
  ...
  afterAll((): void => {
    fs.writeFileSync('packages/apps-config/src/api/typesBundle.ts', `// Copyright 2017-2023 @azero.dev/apps-config authors & contributors
// SPDX-License-Identifier: Apache-2.0

// Do not edit, auto-generated by @azero.dev/apps-config
